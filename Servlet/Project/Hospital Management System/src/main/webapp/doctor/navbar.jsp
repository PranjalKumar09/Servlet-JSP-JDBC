			...
			<form class="d-flex">
				<div class="dropdown">
					<button class="btn btn-light dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false"> 
                        <i class="fas fa-user-circle"></i> ${docObj.getFullName()}
...
<!--
	ECG, Heart Beat , Dataset , Framework, Hear Beat when sensed it contains many annolmy/noises , after removal removal still dont have peak  why, you can work
