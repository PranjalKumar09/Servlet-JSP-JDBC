...
<%@ page import="com.db.DBConnect, java.util.List,  com.entity.Doctor, com.entity.User, com.entity.Appointment, com.dao.AppointmentDAO" %>
<!DOCTYPE html>
<html>
<head>
                    ...
                    <div class="card-body">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                List<Appointment> list = dao.getAllAppointments(user.getId());
